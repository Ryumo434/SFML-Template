...
void Player::handleInput(float deltaTime) {
    ...
    //Beispiel f¸r Rotation basierend auf horizontaler Bewegung:
    if (movement.x < 0)
    ...
    //Schieﬂen mit der Leertaste (nur einmal pro Tastendruck)
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space) && canShoot) {
        ...
        canShoot = false; // Schieﬂen verhindern, bis der Cooldown abgelaufen ist
